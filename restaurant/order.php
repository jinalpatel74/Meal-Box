...
<?php
        ...
        $query1="select * from special_tbl LEFT JOIN order_detail ON special_tbl.Order_id=order_detail.order_id where special_tbl.rest_id=".$_SESSION["Restaurant_id"];
                            ...
                            <table id="basic-datatable" class="table dt-responsive nowrap">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $value["address"];?><div><?php echo $value["state"];?><div><?php echo $value["city"];?></div></td>
                                        <td>
                                            <a href="view_order.php?id=<?php echo $value["Order_id"];?>" class="btn btn-success">View</a>
                                        </td>
                                    </tr>
                                   <?php 
                                }
