...
if(isset($_POST["login_btn"]))
{
    ...
    $query="select * from  restaurant where Restaurant_email='".$email."' and Restaurant_pass='".$password."'";
...
<!-- Start header -->
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food" style="font-family: georgia;">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="res_login.php">Restaurant</a></li>
					</ul>
				</div>
			</div>
		</nav>
	...
	<div class="all-page-title page-breadcrumb">
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1 style="font-family: georgia;font-size: 50px;">RESTAURANT   LOGIN</h1>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="contact-block">
						...
						<?php if(isset($_SESSION["error"])){
								    ?>
								        <div class="badge badge-danger" style="font-size: 15px;font-family: georgia;">
								            Invalid Credentials
								        </div>
								    <?php
								      }
							...
							<div style="margin-left: 240px;margin-bottom: 10px;font-size: 20px;font-family: georgia;">Not registered ? <a href="res_register.php" style="color: #ef652f;font-family: georgia;">Register Now</a></div>
