...
<?php
  if(isset($_POST["update_btn"]))
  {
      ...
      if(isset($_FILES['image'])){
        ...
        // name,contact,email,address,state,city,zip,image,password
    ...
    $insert="INSERT INTO restaurant(Restaurant_name,Restaurant_email,Restaurant_contact,State, City,Restaurant_address, Restaurant_pass, Restaurant_image) VALUES('".$name."','".$email."','".$contact."','".$state."','".$city."','".$address."','".$password."','".$file_name."')";
    
    $res=mysqli_query($con,$insert);
    
    if($res==1)
    {
      echo "<script>window.location='restaurant/login.php';</script>";
         ...
         <form class="needs-validation" method="post" id="register_form"  enctype="multipart/form-data">
           ...
           <div class="row">
             <div class="col-md-6 mb-3">
               ...
               <input type="file" class="form-control" name="image" required="true" placeholder="" value="" required>
               
             </div>
             <div class="col-md-6 mb-3">
               <label for="lastName">Password</label>
               <input type="password" class="form-control" name="password" required="true" placeholder="" value="" required>
               
             </div>
           </div>
           <hr class="mb-4">
           <button class="btn btn-primary btn-lg btn-block mb-2" style="background-color:#bd2130;border-color: #bd2130;" type="submit" name="update_btn">Register</button>

           <span style="margin-left: 500px;color:#bd2130" >Already registered?</span>
           <a class="btn btn-primary btn-sm btn-block text-white mt-2" href="http://localhost/mealbox/restaurant/login.php" style="background-color:#bd2130;border-color: #bd2130;">Login	</a>
         </form>
       </div>
     </div>
